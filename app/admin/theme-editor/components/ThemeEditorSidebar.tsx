  ...
  return (
    <div className="z-20 flex h-full w-[280px] shrink-0 flex-col border-r border-[#ea728c]/20 bg-[#24204b] shadow-2xl">
      ...
      <div className="custom-scrollbar flex-1 overflow-y-auto px-3 py-4">
        <h3 className="mb-3 pl-1 text-[10px] font-bold uppercase tracking-widest text-[#ea728c]">{isHomeEditorPage ? 'Homepage Sections' : isTemplateEditorPage ? `${activePageData.label} Components` : `${activePageData.label} Preview`}</h3>
        {isHomeEditorPage ? (
          <>
