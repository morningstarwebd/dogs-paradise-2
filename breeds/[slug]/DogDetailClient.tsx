    ...
    <div className="pt-24 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {dog.faqs.length > 0 && (
          ...
          >
            <SectionHeading
              title={`${dog.breedName} FAQs`}
              subtitle={`Common questions about ${dog.breedName} puppies in Bangalore.`}
            />
            <div className="space-y-3">
              {dog.faqs.map((faq) => (
                <GlassCard key={faq.question} hover={false} className="p-5">
                  <div className="relative z-10">
