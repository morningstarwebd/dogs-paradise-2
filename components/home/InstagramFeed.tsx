...
export default function InstagramFeed() {
  ...
  return (
    <section className="py-20 lg:py-28 overflow-hidden" id="photo-gallery" ref={containerRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
        <div className="text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="heading-section text-gradient mb-3"
          >
            Puppy Gallery
          </motion.h2>
          <motion.p
          ...
          >
            A glimpse of our adorable family members. Follow us on Instagram @dogsparadice for daily puppy content.
          </motion.p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <motion.div style={{ x: x1 }} className="flex gap-4 pl-4">
