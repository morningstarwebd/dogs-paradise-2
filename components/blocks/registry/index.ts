...
export const BlockRegistry: Record<string, BlockDefinition> = {
    ...
    'happy-stories': {
        ...
        schema: buildSchema([
            ...
            { key: 'card_border_color', label: 'Card Border Color Setting', type: 'color', default: '#ffffff', group: 'Design' },
            { key: 'author_name_text_size_px', label: 'Author Name Text Size (px)', type: 'range', default: 20, min: 12, max: 42, step: 1, group: 'Design' },
            { key: 'author_name_text_color', label: 'Author Name Text Color', type: 'color', default: '#ffffff', group: 'Design' },
            { key: 'location_text_size_px', label: 'Location Text Size (px)', type: 'range', default: 10, min: 8, max: 24, step: 1, group: 'Design' },
            { key: 'location_text_color', label: 'Location Text Color', type: 'color', default: '#ffffff', group: 'Design' },
            { key: 'breed_text_size_px', label: 'Breed Text Size (px)', type: 'range', default: 10, min: 8, max: 24, step: 1, group: 'Design' },
            { key: 'breed_text_color', label: 'Breed Text Color', type: 'color', default: '#ffffff', group: 'Design' },
            { key: 'rating_text_size_px', label: 'Rating Text Size (px)', type: 'range', default: 15, min: 10, max: 28, step: 1, group: 'Design' },
            { key: 'rating_text_color', label: 'Rating Text Color', type: 'color', default: '#FFF0D9', group: 'Design' },
            { key: 'rating_star_color', label: 'Rating Star Color', type: 'color', default: '#ffa600', group: 'Design' },
            { key: 'mobile_dot_active_color', label: 'Mobile Dots Active Color', type: 'color', default: '#ea728c', group: 'Design' },
            { key: 'mobile_dot_inactive_color', label: 'Mobile Dots Inactive Color', type: 'color', group: 'Design' },
            { key: 'heading_text_size_px', label: 'Heading Text Size (px)', type: 'range', default: 56, min: 24, max: 96, step: 1 },
    ...
    'trust-badges': {
        ...
        label: 'Trust Badges',
        schema: buildSchema([
            { key: 'eyebrow_text', label: 'Eyebrow Text', type: 'text', default: 'Trusted and Transparent' },
            { key: 'eyebrow_text_size_px', label: 'Eyebrow Text Size (px)', type: 'range', default: 12, min: 9, max: 24, step: 1 },
            { key: 'eyebrow_text_color', label: 'Eyebrow Text Color', type: 'color', default: '#6b7280' },
            { key: 'heading', label: 'Heading', type: 'text', default: 'Built on Trust & Transparency' },
            { key: 'heading_text_size_px', label: 'Heading Text Size (px)', type: 'range', default: 46, min: 20, max: 84, step: 1 },
            { key: 'heading_text_color', label: 'Heading Text Color', type: 'color', default: '#0f172a' },
            { key: 'subheading', label: 'Subheading', type: 'textarea', default: 'Proof points that matter for responsible adoption.' },
            { key: 'subheading_text_size_px', label: 'Subheading Text Size (px)', type: 'range', default: 16, min: 11, max: 32, step: 1 },
            { key: 'subheading_text_color', label: 'Subheading Text Color', type: 'color', default: '#475569' },
            { key: 'icon_color_global', label: 'Icon Color (Global)', type: 'color', default: '#ea728c' },
            { key: 'card_bg_color', label: 'Card Background Color', type: 'color', default: '#f8f5ef' },
            { key: 'card_border_color', label: 'Card Border Color', type: 'color', default: '#e6e0d8' },
            { key: 'card_radius_px', label: 'Card Radius (px)', type: 'range', default: 24, min: 8, max: 48, step: 1 },
            { key: 'card_title_text_size_px', label: 'Card Title Text Size (px)', type: 'range', default: 16, min: 11, max: 34, step: 1 },
            { key: 'card_title_text_color', label: 'Card Title Text Color', type: 'color', default: '#0f172a' },
            { key: 'card_subtitle_text_size_px', label: 'Card Subtitle Text Size (px)', type: 'range', default: 14, min: 10, max: 28, step: 1 },
            { key: 'card_subtitle_text_color', label: 'Card Subtitle Text Color', type: 'color', default: '#475569' },
            { key: 'icon_chip_bg_color', label: 'Icon Chip Background (Optional)', type: 'color', default: '' },
            { key: 'icon_chip_size_px', label: 'Icon Chip Size (px)', type: 'range', default: 82, min: 40, max: 140, step: 1 },
            { key: 'icon_size_px', label: 'Icon Size (px)', type: 'range', default: 34, min: 14, max: 70, step: 1 },
            { key: 'icon_chip_radius_px', label: 'Icon Chip Radius (px)', type: 'range', default: 22, min: 8, max: 48, step: 1 },
            { key: 'mobile_layout_mode', label: 'Mobile Layout Mode', type: 'select', options: ['carousel', 'vertical'], default: 'carousel' },
            { key: 'mobile_vertical_gap_px', label: 'Mobile Vertical Gap (px)', type: 'range', default: 14, min: 8, max: 32, step: 1 },
            { key: 'carousel_autoplay_enabled', label: 'Mobile Carousel Auto Play', type: 'toggle', default: true },
            { key: 'carousel_autoplay_interval_ms', label: 'Mobile Carousel Auto Play Interval (ms)', type: 'range', default: 2800, min: 1200, max: 10000, step: 100 },
        ]),
        ...
        schema: buildSchema([
            {
                ...
                type: 'color',
                default: 'linear-gradient(90deg, #020817 0%, #0b1f4d 50%, #020817 100%)',
            },
            { key: 'strip_border_color', label: 'Strip Border Color', type: 'color', default: '#22335f' },
            { key: 'strip_radius_px', label: 'Strip Radius (px)', type: 'range', default: 20, min: 0, max: 48, step: 1 },
            { key: 'strip_padding_y_px', label: 'Strip Vertical Padding (px)', type: 'range', default: 20, min: 8, max: 40, step: 1 },
            { key: 'strip_padding_x_px', label: 'Strip Horizontal Padding (px)', type: 'range', default: 24, min: 10, max: 56, step: 1 },
            { key: 'strip_gap_px', label: 'Item Gap (px)', type: 'range', default: 16, min: 8, max: 36, step: 1 },
            { key: 'show_item_dividers', label: 'Show Item Dividers', type: 'toggle', default: true },
            { key: 'divider_color', label: 'Divider Color', type: 'color', default: '#2b3f73' },
            { key: 'icon_chip_bg_color', label: 'Icon Chip Background', type: 'color', default: 'rgba(255,255,255,0.06)' },
            { key: 'icon_chip_border_color', label: 'Icon Chip Border', type: 'color', default: 'rgba(255,255,255,0.16)' },
            { key: 'icon_chip_size_px', label: 'Icon Chip Size (px)', type: 'range', default: 56, min: 32, max: 90, step: 1 },
            { key: 'icon_size_px', label: 'Icon Size (px)', type: 'range', default: 22, min: 14, max: 44, step: 1 },
            { key: 'icon_color', label: 'Icon Color', type: 'color', default: '#f8fafc' },
            { key: 'metric_text_size_px', label: 'Metric Text Size (px)', type: 'range', default: 38, min: 20, max: 72, step: 1 },
            { key: 'metric_text_color', label: 'Metric Text Color', type: 'color', default: '#f8fafc' },
            { key: 'title_text_size_px', label: 'Title Text Size (px)', type: 'range', default: 15, min: 10, max: 32, step: 1 },
            { key: 'title_text_color', label: 'Title Text Color', type: 'color', default: '#f8fafc' },
            { key: 'subtitle_text_size_px', label: 'Subtitle Text Size (px)', type: 'range', default: 12, min: 9, max: 26, step: 1 },
            { key: 'subtitle_text_color', label: 'Subtitle Text Color', type: 'color', default: '#9fb0d9' },
            { key: 'badge_bg_color', label: 'Badge Background', type: 'color', default: '#10b981' },
            { key: 'badge_text_color', label: 'Badge Text Color', type: 'color', default: '#ffffff' },
            { key: 'badge_text_size_px', label: 'Badge Text Size (px)', type: 'range', default: 14, min: 10, max: 28, step: 1 },
            { key: 'mobile_layout', label: 'Mobile Layout', type: 'select', options: ['scroll', 'stack'], default: 'scroll' },              { key: 'mobile_items_per_view', label: 'Mobile Items Per View (Scroll Mode)', type: 'select', options: ['Auto (Uses Min Width)', '1 Item', '1.2 Items', '1.5 Items', '2 Items'], default: '1 Item' },            { key: 'mobile_item_min_width_px', label: 'Mobile Item Min Width (px)', type: 'range', default: 260, min: 180, max: 420, step: 1 },
        ]),
        blocks: credibilityStripBlocks,
